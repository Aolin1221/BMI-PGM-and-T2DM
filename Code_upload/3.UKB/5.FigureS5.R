...
####绘制森林图（补充图5）####
forest_total<-read_xlsx("C:/Users/DELL/Desktop/UKB/output/forestukb.xlsx",col_names = TRUE) 

cairo_pdf("C:/Users/DELL/Desktop/UKB/output/forest_Ukb.pdf",width=15.0,height=16.0)
